...
#ifndef GLOBALS_H
#	define GLOBALS_H
#include "arduinoFFT/arduinoFFT.h" // Standard Arduino FFT library https://github.com/kosme/arduinoFFT
...
extern const int AUDIO_INPUT_PIN;; // Input ADC pin for audio data. See board specfic pins header file. **A6**
extern const int ANALOG_READ_RESOLUTION;; // Bits of resolution for the ADC.
extern const int ANALOG_READ_AVERAGING;; // Number of samples to average with each ADC reading.
